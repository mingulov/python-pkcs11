...
class KeyType(IntEnum):
    ...
    # PKCS#11 v3.0 — additional key types
    HKDF = 0x00000042
...
class Mechanism(IntEnum):
    ...
    * salt length, default is 20
    ...
    TLS_MAC = 0x000003E4
    TLS_KDF = 0x000003E5
    TLS12_EXTENDED_MASTER_KEY_DERIVE = 0x00000056
    TLS12_EXTENDED_MASTER_KEY_DERIVE_DH = 0x00000057
    ...
    IKE2_PRF_PLUS_DERIVE = 0x0000402E
    IKE_PRF_DERIVE = 0x0000402F
    IKE1_PRF_DERIVE = 0x00004030
    IKE1_EXTENDED_DERIVE = 0x00004031
    ...
    * other participant's :attr:`pkcs11.constants.Attribute.EC_POINT`
    ...
    # Note: SHA3 RSA PKCS/PSS mechanisms already defined above (0x60-0x67)

    # PKCS#11 v3.0 — SHA-512 truncated variants
    ...
    # PKCS#11 v3.0 — ChaCha20/Poly1305/Salsa20
    ...
    # PKCS#11 v3.0 — BLAKE2B digest mechanisms
    BLAKE2B_160 = 0x0000400C
    BLAKE2B_256 = 0x00004011
    BLAKE2B_384 = 0x00004016
    BLAKE2B_512 = 0x0000401B

    # PKCS#11 v3.0 — NULL mechanism (no-op passthrough)
    CKM_NULL = 0x0000400B

    # PKCS#11 v3.0 — Signal protocol mechanisms
    ...
    # PKCS#11 v3.0 — Derive public key from private key
    PUB_KEY_FROM_PRIV_KEY = 0x0000403A

    # Note: AES_CCM (0x1088) and AES_GMAC (0x108E) already defined above

    # PKCS#11 v3.0 — AES-XTS
    AES_XTS = 0x00002110
    AES_XTS_KEY_GEN = 0x00002111

    # PKCS#11 v3.0 — ECDH AES key wrap
