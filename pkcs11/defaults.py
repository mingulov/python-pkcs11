...
DEFAULT_GENERATE_MECHANISMS: Final[dict[KeyType, Mechanism]] = {
    ...
    KeyType.XMSS: Mechanism.XMSS_KEY_PAIR_GEN,
    KeyType.XMSSMT: Mechanism.XMSSMT_KEY_PAIR_GEN,
...
DEFAULT_KEY_CAPABILITIES: Final[dict[KeyType, MechanismFlag | int]] = {
    ...
    KeyType.XMSS: _SIGNING,
    KeyType.XMSSMT: _SIGNING,
...
DEFAULT_SIGN_MECHANISMS: Final[dict[KeyType, Mechanism]] = {
    ...
    KeyType.XMSS: Mechanism.XMSS,
    KeyType.XMSSMT: Mechanism.XMSSMT,
